...
export async function getOAuth2Client(userId) {
  ...
  if (!decryptedRefreshToken) {
    console.warn(`⚠️ No hay refresh_token para el usuario ${userId}. La cuenta necesita reconectarse.`);
    console.warn(`   URL de reconexión: ${process.env.FRONTEND_URL || 'http://localhost:3000'}/google-calendar/connect?userId=${userId}`);
