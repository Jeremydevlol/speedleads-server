 ...
 * (usa STRIPE_PRICE_ID y FRONTEND_URL desde tu .env)
 */
export async function createCheckoutSession(customerId) {
  const session = await stripe.checkout.sessions.create({
    ...
    success_url: `${process.env.FRONTEND_URL}/success`, // Ajusta tu ruta de éxito
    cancel_url: `${process.env.FRONTEND_URL}/cancel`,  // Ajusta tu ruta de cancelación
  })
  return session
}
